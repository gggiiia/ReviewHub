        ...
        <form onSubmit={handleSubmit(submit)} className="space-y-3 mt-3">
          <div>
            ...
            <Textarea
              ...
              {...register("reply", { required: "Reply is required", minLength: { value: 2, message: "Reply is too short" } })}
            />
            {errors.reply && (
          ...
          <DialogFooter>
            <Button className={"mr-auto"} type="button" variant="outline" onClick={generateAiReply} disabled={aiLoading || isSubmitting}>
            ...
            <Button type="submit" disabled={isSubmitting}>{isSubmitting ? "Submitting..." : "Send reply"}</Button>
          </DialogFooter>
